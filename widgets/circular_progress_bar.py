...
class CircularProgressBar(ProgressBar):
    ...
    def draw(self):
        ...
        with self.canvas:
            ...
            Ellipse(pos=self.pos_mem, size=self.size_mem)
            ...
            Color(0, 0, 0)
            Ellipse(pos=(self.pos_mem[0] + self.thickness / 2, self.pos_mem[1] + self.thickness / 2),
                    size=(self.size_mem[0] - self.thickness, self.size_mem[1] - self.thickness))

            # Center and draw the progress text
            Color(1, 1, 1, 1)
            Rectangle(texture=self.label.texture, size=self.texture_size,
                      pos=(self.size_mem[0]/2 - self.texture_size[0]/2, self.size_mem[1]/2 - self.texture_size[1]/2))
